...
| --------------------- | -------------------- | ---------------------------------------------------------------------------------------------------- |
| Windows               | NSIS installer       | [Keyper.Setup.v1.2.1-win-x64.exe](https://pub-da847cd0fc1045b3a5a7fcc39a3be134.r2.dev/Keyper.Setup.v1.2.1-win-x64.exe) |
| Linux                 | AppImage (ARM64)     | [Keyper-1.2.1-arm64.AppImage](https://pub-da847cd0fc1045b3a5a7fcc39a3be134.r2.dev/Keyper-1.2.1-arm64.AppImage)   |
| Linux                 | AppImage (AMD64)     | [Keyper-1.2.1-x86_64.AppImage](https://pub-da847cd0fc1045b3a5a7fcc39a3be134.r2.dev/Keyper-1.2.1-x86_64.AppImage)   |
| Linux (Debian/Ubuntu) | `.deb` (x86_64)      | [keyper_1.2.1_amd64.deb](https://pub-da847cd0fc1045b3a5a7fcc39a3be134.r2.dev/keyper_1.2.1_amd64.deb) |
| Linux (Debian/Ubuntu) | `.deb` (ARM64)       | [keyper_1.2.1_arm64.deb](https://pub-da847cd0fc1045b3a5a7fcc39a3be134.r2.dev/keyper_1.2.1_arm64.deb) |

**Windows quick start:**

1. Download [Keyper.Setup.v1.2.1-win-x64.exe](https://pub-da847cd0fc1045b3a5a7fcc39a3be134.r2.dev/Keyper.Setup.v1.2.1-win-x64.exe).
...
```bash
chmod +x Keyper-1.2.1-x86_64.AppImage
./Keyper-1.2.1-x86_64.AppImage
```

**Linux .deb quick start:**

```bash
sudo dpkg -i keyper_1.2.1_amd64.deb
