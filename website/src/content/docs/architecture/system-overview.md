...
3. Storage layer: Supabase (Postgres), Neon Postgres, or SQLite (sql.js / IndexedDB) tables for credentials, categories, and vault config — selected at runtime via the database provider setting.
