...
export const EditCredentialModal = ({
 ...
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">Token Value</label>
 <Input
 type="password"
 ...
 <label className="text-sm font-medium text-foreground">Certificate Data</label>
 <input
 ...
 className="bg-background border-border focus:ring-1 focus:ring-neutral-500 text-foreground font-mono text-xs"
 rows={5}
 ...
 <div className="space-y-2">
 <label className="text-sm font-medium text-foreground">Sensitive Value</label>
 <Textarea
